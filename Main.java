...
public class Main {
     ...
     */
     public static void main(String[] args) {
        ...
        System.out.print("¿Cuántas historias de usuario deseas ingresar?: ");
        ...
        for (int i = 0; i < cantidad; i++) {
            ...
            historias.add(new HistoriaUsuario(id, rol, funcionalidad, razon, criterio, contexto, evento, resultadoEsperado));
        }
